...
func (rw *readerWriter) append(ctx context.Context, src []byte, name string) error {
	...
	_, err = appendBlobURL.CommitBlockList(ctx, base64BlockIDs, blob.BlobHTTPHeaders{}, blob.Metadata{}, blob.BlobAccessConditions{}, blob.AccessTierNone, blob.BlobTagsMap{}, blob.ClientProvidedKeyOptions{})
	if err != nil {
		return err
	}
	return nil
